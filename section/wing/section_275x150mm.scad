...
//wing_section_275x150mm();
wing_section_275x150mm_central();
module wing_section_275x150mm(px=0, py=0, pz=0, rx=0, ry=0, rz=0){
    translate([(px), (py), pz])
    rotate([rx,ry,rz]){
...
module wing_section_275x150mm_central(px=0, py=0, pz=0, rx=0, ry=0, rz=0){
    translate([(px), (py), pz])
    rotate([rx,ry,rz]){
        longeron_T_275mm(0, 0.5,4,  -68,0,0);
        longeron_I_275mm(0, 149.6,1.2,  0,0,180);
        longeron_T_275mm(0, 45,0.38,  0,0,0);
        longeron_T_275mm(0, 20,14.9,  192,0,0);
        longeron_T_275mm(0, 45,17.5,  180,0,0);
        //longeron_T_275mm(275/2, 85,20,  180,0,0);
        
        nervure_clark_150mm_std(0,0,0,  90,0,90);
        nervure_clark_150mm_support(68.75,0,0,  90,0,90);
        nervure_clark_150mm_std(68.75*2,0,0,  90,0,90);
        nervure_clark_150mm_support(-68.75,0,0,  90,0,90, mz=1);
        nervure_clark_150mm_std(-68.75*2,0,0,  90,0,90, mz=1);
	}//transform
}//module
